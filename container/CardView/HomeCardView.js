            ...
            <View style={styles.CardContainer2}>
                <View style={styles.rowCard}>
                    ...
                    <View style={styles.Text}>
                        <Text style={styles.Title} numberOfLines={1}>{item[0].name}</Text>
                        <Text style={styles.place} numberOfLines={2}>{item[0].place}</Text>
                ...
                {item.length > 1 ?
                    <View style={styles.rowCard}>
                        ...
                        <View style={styles.Text}>
                            <Text style={styles.Title} numberOfLines={1}>{item[1].name}</Text>
                            <Text style={styles.place} numberOfLines={2}>{item[1].place}</Text>
